...
/**
 * This checked exception describes situations in which a user, as represented
 ...
 */
public class UserDoesNotExistException extends Exception implements AnnotatedException {

    private static final long serialVersionUID = 1L;

    /**
     * Creates a new UserDoesNotExistException instance.
     */
    ...
    /**
     * Creates a new UserDoesNotExistException instance with a
	...
	public String getPersonalizedMessage() {
    	...
    	return bundle.getString("exception.userDoesNotExist");
	}
