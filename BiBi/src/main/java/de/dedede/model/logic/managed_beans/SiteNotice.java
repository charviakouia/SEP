...
public class SiteNotice {
	...
	@PostConstruct
	public void init() {
		String text = appData.getApplicationCustomization().getSiteNotice();
		textContainer.setSiteNotice(text);
	}
	...
	public void save() {
		...
		newData.setSiteNotice(textContainer.getSiteNotice());
		try {
			...
			Logger.severe("An unexpected error occured during saving of"
					+ " new site notice, the db entry couldn't be found.");
		}
