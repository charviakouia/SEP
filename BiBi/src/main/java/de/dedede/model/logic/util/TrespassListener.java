 ...
 * ({@link UserDto}, NormalUser, Admin, LibraryStaff. The user roles are
 * structured as in the following: NormalUser - LibraryStaff - Admin. The user
 * role can access all pages of them. If a lower role navigates to a page, where
 * he has no rights for a message appears that this page does not exists.
 */
public class TrespassListener implements PhaseListener {

	/**
	 * The processes the TrespassListener performs before the phase is executed. In
	 * this case the method is empty.
	 *
