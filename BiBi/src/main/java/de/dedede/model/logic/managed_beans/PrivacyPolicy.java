...
public class PrivacyPolicy  {
	...
	@PostConstruct
	public void init() {
		String text = appData.getApplicationCustomization().getPrivacyPolicy();
		textContainer.setPrivacyPolicy(text);
	}
	...
	public void save() {
		...
		newData.setPrivacyPolicy(textContainer.getPrivacyPolicy());
		try {
			...
			Logger.severe("An unexpected error occured during saving of"
					+ " new privacy policy, the db entry couldn't be found.");
		}
