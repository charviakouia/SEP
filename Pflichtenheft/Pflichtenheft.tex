...
In den Abbildungen \ref{katstoeb} und \ref{katstoebmit} werden die einzelnen Unterseiten der Webapplikation skizzenhaft dargestellt.

\begin{figure}[h]
    \centering
    \includegraphics[width = 40em]{Kategorienstöberer}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 40em]{Kategorienstöberer_Mitarbeiter}
