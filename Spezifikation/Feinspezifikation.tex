...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width = 45em]{Klassendi}
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.09]{KlassendiagrammVollst.pdf}
        \caption{UML-Klassendiagramm }
...
\begin{center}
    \begin{figure}[H]
        \includegraphics[scale=0.7]{KlassendiagrammExceptionObere.pdf}
...
Referenzierte Validatoren sind implizit im Paket \M{de.dedede.model.logic.validators}.
