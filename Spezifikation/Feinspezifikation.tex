...
\DRP & \M{value} & \MB{attribute.attributeMultiplicity} & \ADM\\
...
\begincontrols[admin/user-search]
    ...
    \CHK & \M{value} & \MB{userSearch.userLendStatus} & \ADM\\
    %TODO beacon
    \LST & & & \ADM\\
...
\begincontrols[account/profile]
    ...
    \DRP & \M{value} & \MB{profile.user.userRole} & \ADM\\
    \CHK & \M{value} & \MB{profile.user.userLendStatus} & \ADM\\
...
\begincontrols[public/registration]
    ...
    \DRP & \M{value} & \MB{registration.user.userRole} & \ADM\\
...
\begincontrols[admin/administration]
    ...
    \CHK & \M{value} & \MB{administration.application.systemRegistrationStatus} & \ADM\\
