...
\begin{figure}[H]
\hypertarget{Session}{}
    \includegraphics[scale=0.12]{UMLBibi.pdf}
  ...
  \begin{center}
    \begin{table}
        \begin{tabular} { |p{3,5cm}|p{7,5cm}| }
            ...
            \hline
            MailDao & Kontrolliert den Zugriff auf die Emailsendung in der Datenbank. \\
            \hline
            NoConnectionException & Wird geworfen wenn der Zugriff auf die Daten-bank fehlschlägt. \\
            \hline
            NoDataException & Wird geworfen wenn eine Datenanfrage aufgrund nicht vorhandener Daten kein Ergebnis zurückgibt. \\
            \hline
        \end{tabular}
        \end{table}
        \end{center}
